...
public class Game extends JFrame {
    ...
    public Game(int width, int height) {
        ...
        world = new CannonWorld(getWidth() - 200, getHeight() - 200);
        ...
        gravitySlider.setBounds(world.getX() + world.getWidth() + 45, world.getY(), 50, world.getHeight());
        ...
        gravitySlider.addChangeListener(event-> {
            ...
            gravityField.setText(world.getGravity() + "G");
        });
        add(gravitySlider);

        JSlider windSlider = new JSlider();
        windSlider.setOrientation(SwingConstants.VERTICAL);
        windSlider.setBounds(world.getX() + world.getWidth() + 80, world.getY(), 50, world.getHeight());
        windSlider.setMinimum(-10);
